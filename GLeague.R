...
bios22 <- read_csv("Desktop/Basketball Analysis/GLeague/Data/bios22.csv")
...
gleague2022 <- read_csv("Desktop/Basketball Analysis/GLeague/Data/gleague2022.csv")
gleague2022 <- gleague2022[-1]
View(gleague2022)
gleague2022 %>% filter(Player == "Mac McClung")
summary(gleague2022['GP'])
hist(gleague2022$GP)
callups2022 <- read_csv("Desktop/Basketball Analysis/GLeague/Data/callups2022.csv")
View(callups2022)
...
backwardBIC <- step(full, direction = 'backward', k = log(267))
...
bios21 <- read_csv("Desktop/Basketball Analysis/GLeague/Data/bios21.csv")
# Select important columns and convert height to total inches
bios21 <- bios21 %>%
  select(Player, Pos, HT, WT, `NBA Draft Status`) %>%
  separate(HT, c('HT', 'inches'), sep = '-', convert = TRUE, remove = FALSE) %>%
...
gleague2021 <- read_csv("Desktop/Basketball Analysis/GLeague/Data/gleague2021.csv")
gleague2021 <- gleague2021[-1]
View(gleague2021)
gleague2021 %>% filter(Player == "Jeremy Lin")
summary(gleague2021['GP'])
hist(gleague2021$GP)
callups2021 <- read_csv("Desktop/Basketball Analysis/GLeague/Data/callups2021.csv")
View(callups2021)
...
# PIE Analysis
pie22 <- read_csv("Desktop/Basketball Analysis/GLeague/Data/pie_df22.csv")
...
gleague2023 <- read_csv("Desktop/Basketball Analysis/GLeague/Data/gleague2023.csv")
...
write.csv(final_df22, file = "Desktop/Basketball Analysis/GLeague/Dataa/final_df22.csv") 
write.csv(pic_df21, file = "Desktop/Basketball Analysis/GLeague/Data/final_df21.csv")
write.csv(pic_df23, file = "Desktop/Basketball Analysis/GLeague/Data/final_df23.csv")
